...
if __name__ == '__main__':
    QA1.ENTITIES = ['client', 'program_name', 'outcome']
    ...
    qa1.update_given_ner(in_entity="outcome", givens={"well rounded and spiritually sound youths and teenagers": 0.5})
    qa1.update_given_ner(in_entity="program_name", givens={"St.Mary's Church": 0.5})
    print(qa1.given)
